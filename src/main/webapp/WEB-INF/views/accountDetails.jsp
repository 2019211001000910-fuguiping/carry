                            ...
                            <tr>
                                <td colspan="6">
                                    <div class="content-404 text-center">
                                        <img src="<%=basePath %>images/cart/no_order.png" class="img-responsive"
                                             alt=""/>
                        ...
                        <c:otherwise>
                            ...
                            <c:forEach var="o" items="${orderList}">
                                <tr>
                                    ...
                                    <td class="cart_total">
                                        <%
                                            com.fuguiping.model.Order o = (com.fuguiping.model.Order) pageContext.findAttribute("o");
                                            int n = o.getPaymentId();
                                            java.sql.Connection con = (java.sql.Connection) application.getAttribute("con");
                                            String paymentType = com.fuguiping.model.Payment.findByPaymentId(con, n);
                                        %>
                                        <p class="cart_total_price"><%=paymentType %>
                                        </p>
                                    </td>
                                    <td>
                                        <button class="btn btn-default update" id="${o.orderId}" name="button">Details
                                        </button>
                                    </td>
