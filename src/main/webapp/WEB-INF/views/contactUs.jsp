...
<script type="text/javascript">
    ...
    var markerArr = [{
        title: "鎴戠殑鏍囪",
        content: "鎴戠殑澶囨敞<br/>姹熻タ鐪佸崡鏄屽競缁忔祹鎶€鏈紑鍙戝尯鍙屾腐涓滃ぇ琛808鍙<br/>(0791)87046576",
        point: "115.873619|28.750131",
        isOpen: 0,
    ...
    function createIcon(json) {
        var icon = new BMap.Icon("<%=basePath%>images/home/pin.png", new BMap.Size(json.w, json.h), {
