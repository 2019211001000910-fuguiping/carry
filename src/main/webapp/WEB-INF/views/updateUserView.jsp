            ...
            <div class="col-sm-4 col-sm-offset-1">
                <div class="login-form"><!--login form-->
                    ...
                    <% if (!(request.getAttribute("user") == null)) {
                        com.fuguiping.model.User u = (com.fuguiping.model.User) request.getAttribute("user");
                    %>
                    <%
                    ...
                    <form method="post" action="updateUser">
                        ...
                        &nbsp;<input type="radio" style="width: 15px; height: 15px; display:inline;" name="gender"
                                     value="male" <%="male".equals(u.getGender()) ? "checked" : ""%> />&nbsp;Male&nbsp;
                        <input type="radio" style="width: 15px; height: 15px;   display: inline;" name="gender"
                               value="female" <%="female".equals(u.getGender()) ? "checked" : ""%>/>&nbsp;Female
                        <br/><br/>
